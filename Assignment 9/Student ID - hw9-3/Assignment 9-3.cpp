...
void testAssignment4()
{
    ...
    for (unsigned int i = 0; i < number; i++)
    {
        ...
        for (size_t i = 0; i < numRows; ++i)
        {
            ...
            {
                //cout << addressBefore[rowBefore] << " " << addressAfter[rowAfter] << endl;
                correct = false;
                break;
            }
            rowBefore = (rowBefore + 1) % mapSizeBefore;
